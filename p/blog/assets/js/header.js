...
<!--// search menu -->
<div class="flex flex-none items-center px-2 md:px-4 z-11 relative min-w-min">
  ...
  <span id="search-icon" class="absolute right-4 text-gray-600 cursor-pointer"><i class="fas fa-search text-2xl"></i></span>
</div>`;

...
<div class="flex flex-grow md:w-64 items-center z-10">
  <a href="#" class="flex m-auto md:ml-3 text text-gray-200 items-center font-semibold tracking-widest uppercase focus:outline-none focus:shadow-outline">
    <img class="w-8 h-8 mr-2" src="${documentRoot}assets/images/logo.png" alt="Site Logo" />
    Web Console
  </a>
</div>
<!--// personal menu -->
...
document.addEventListener("DOMContentLoaded", function(){
  ...
  // 헤더 class 삽입
  headerObj.classList.add('flex', 'flex-none', 'w-full', 'h-14', 'bg-gray-800', 'sticky', 'top-0', 'z-10');
  // 헤더 HTML 삽입
